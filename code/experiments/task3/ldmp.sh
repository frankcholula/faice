...
#    --train_batch_size 64 \
#    --eval_batch_size 64 \
#    --wandb_run_name liang_unet_l_block_5_head_dim_64_ldmp_ddim_scaled_linear_vqvae3_loss_weight0.4bs16_bs64 \
#    --calculate_fid \
#    --calculate_is \
#    --no_confirm
#    --no_wandb
...
#python main.py \
#    --dataset face \
#    --model unet_l_block_6_head_dim_64_layer_4 \
#    --pipeline ldmp \
#    --scheduler ddim \
#    --beta_schedule scaled_linear \
#    --image_size 128 \
...
#    --train_batch_size 64 \
#    --eval_batch_size 64 \
#    --wandb_run_name liang_unet_l_block_6_head_dim_64_layer_4_ldmp_ddim_scaled_linear_vqvae3_loss_weight0.4bs16_bs64 \
#    --calculate_fid \
#    --calculate_is \
#    --no_confirm
#    --no_wandb
...
python main.py \
    --dataset face \
    --model unet_xl_block_6_head_dim_64_layer_6 \
    --pipeline ldmp \
    --scheduler ddim \
    --beta_schedule scaled_linear \
    --image_size 128 \
    ...
    --train_batch_size 64 \
    --eval_batch_size 64 \
    --wandb_run_name liang_unet_xl_block_6_head_dim_64_layer_6_ldmp_ddim_scaled_linear_vqvae3_loss_weight0.4bs16_bs64 \
    --calculate_fid \
    --calculate_is \
    --no_confirm \
    --no_wandb